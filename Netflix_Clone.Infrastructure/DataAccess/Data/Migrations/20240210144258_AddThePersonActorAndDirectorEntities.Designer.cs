...
namespace Netflix_Clone.Infrastructure.DataAccess.Data.Migrations
{
    ...
    [Migration("20240210144258_AddThePersonActorAndDirectorEntities")]
    partial class AddThePersonActorAndDirectorEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Netflix_Clone.Domain.Entities.ContentActor", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("ContentActor");
                });

            modelBuilder.Entity("Netflix_Clone.Domain.Entities.ContentDirector", b =>
                {
                    b.HasBaseType("Netflix_Clone.Domain.Entities.Person");

                    b.HasDiscriminator().HasValue("ContentDirector");
                });
            ...
            modelBuilder.Entity("Netflix_Clone.Domain.Entities.Content", b =>
                {
                    b.HasOne("Netflix_Clone.Domain.Entities.ContentGenre", "Genre")
